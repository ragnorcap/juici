...
async function main() {
  ...
  const basicPrompts = generateUniquePrompts(generateBasicPrompt, 10, existingPrompts);
  const moderatePrompts = generateUniquePrompts(generateModeratePrompt, 20, existingPrompts);
